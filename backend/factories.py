...
from backend.interfaces import (
    IComponentFactory, IConsensusAlgorithm, IPathfindingAlgorithm,
    ICollisionAvoidance, IPhysicsEngine, IFormationPlanner,
    ICommunicationManager, IEnvironment
)
from backend.coordinator import ConsensusAlgorithm, CollisionAvoidance, SwarmCoordinator
from backend.pathfinding import Pathfinding3D, FormationPathPlanner
from backend.physics import DronePhysics, SwarmPhysics, Environment
from backend.coordinator import SwarmConfig, Formation
...
# Imports necessários para evitar circular imports
import numpy as np
import time
